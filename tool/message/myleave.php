<?php
          $sqlq = mysql_query("select * from tb_user where usernc='".$_SESSION['unc']."'",$conn);
		  $my = mysql_fetch_array($sqlq);
			 $sql=mysql_query("select count(*) as total from tb_leaveword where userid='".$my['id']."'",$conn);
			 ...
			 if($total==0){
			  echo "<div align=center>对不起，暂无留言！</div>";
			   ...
			   $sql=mysql_query("select * from tb_leaveword where userid='".$my['id']."' order by createtime desc limit ".($page-1)*$pagesize.",$pagesize  ",$conn);
...
<div align="right">
			 ...
			 ?>
			 <a href="reply.php" class="a1"><img src="image/message.png" height="20px"></a>
			 <?php
			  }else if($adm!=""){
			 ?> 
			 <a href="reply.php" class="a1"><img src="image/message.png" height="20px"></a>
