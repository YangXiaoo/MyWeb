...
<div align="right">
			  ...
			  <?php 
			   ...
			   $sqllook=mysql_query("select count(*) as total from tb_lookhistory where leavewordid='".$info['id']."'",$conn);
...
<?php
			 ...
			 ?>
			 <a href="reply.php?t_id=<?php echo $info['id'] ?>" class="a1"><img src="image/message.png" height="20px"></a>
			 <?php
			  }else if($adm!=""){
			 ?> 
			 <a href="reply.php?t_id=<?php echo $info['id'] ?>" class="a1"><img src="image/message.png" height="20px"></a>
